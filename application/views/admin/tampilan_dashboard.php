...
<head>
  ...
  <!-- DataTables -->
  <link rel="stylesheet" href="<?php echo base_url(); ?>assets/css/datatables.net-bs/dataTables.bootstrap.min.css">
  <!-- Select2 -->
...
<div class="wrapper">
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <!-- /.search form -->
      <?php $this->load->view('admin/wrapper/tampilan_menu'); ?>
    </section>
    <!-- /.sidebar -->
  </aside>
...
<!-- Sparkline -->
<script src="<?php echo base_url(); ?>assets/js/jquery-sparkline/jquery.sparkline.min.js"></script>
<!-- jvectormap  -->
